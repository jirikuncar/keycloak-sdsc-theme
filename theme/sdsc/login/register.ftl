        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
          <#if !realm.registrationEmailAsUsername>
            ...
            <div class="form-group">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.cscs_name" class="${properties.kcLabelClass!}">${msg("cscs_name")}</label>
                </div>

                <div class="${properties.kcInputWrapperClass!}">
                    <input type="text" class="${properties.kcInputClass!}"  id="user.attributes.street" name="user.attributes.cscs_name" value="${(register.formData['user.attributes.cscs_name']!'')?html}"/>
                </div>
            </div>
